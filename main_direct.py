...
if False: #% generate dataset beads
    DS1 = dataset_simulation(imgshape=[256, 512], linked=True, pix_size=159,
...
#    DS1.find_neighbours(maxDistance=1500, k=30)
...
DS1.Train_Affine(lr=learning_rate, epochs=epochs*2)
...
#%% Image overview
if True:
    DS1.generate_channel(precision=159)
    DS1.plot_channel()
    #DS1.plot_1channel()